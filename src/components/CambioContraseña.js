...
const CambioContraseña = ({ albumId }) => {
    ...
    const changePassword = async (email, newPassword) => {
        try {
            const response = await fetch(`https://www.stickeralbum.somee.com/api/Passwords/ChangePassword?email=${encodeURIComponent(email)}&newPassword=${encodeURIComponent(newPassword)}`, {
                method: 'POST',
                headers: {
