...
import EspStars from './esp-apodo.png';
import Icon from '../../../icon.png';
import Icon2 from '../../../flecha-abajo.png';
import Icon3 from '../../../cerrar-sesion.png';

const España = ({ albumId, savedStickers, pastedStickers, setPastedStickers}) => {
    ...
    const cards = Array.from({ length: 12 }, (_, index) => index + 125);
    ...
    const handlePasteSticker = async (stickerId) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                localStorage.setItem('pastedStickersAux', JSON.strEspify(updatedStickersAux));
    ...
    return (
        <div className='full-screen'>
            ...
            <div className='album-container'>
                <div className='españa-album'>
                    <div className='title-country-container'>
                        <img src={Esp} alt="Bandera de España" className="esp-flag"/>
                        <h1 className="esp-title"> ESPAÑA </h1>
                    </div>
                    <img src={EspStars} alt="Estrellas de España" className="esp-stars"/>
                    <div className="row1">
                        {firstRow.map(card => (
