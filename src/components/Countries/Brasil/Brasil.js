...
const Brasil = ({ albumId, savedStickers, pastedStickers, setPastedStickers}) => {
    ...
    const cards = Array.from({ length: 12 }, (_, index) => index + 97);
            ...
            <div className='album-container'>
                <div className='brasil-album'>
                    ...
                    <div className="row1">
                        ...
                        <div className='page-album'><b>3</b></div>
                    </div>
                    <div className="row2">
                        {secondRow.map(card => (
                            <div key={card} className={`card ${isStickerSaved(card) ? 'highlight' : ''} ${pastedStickersAux[card] ? 'pasted' : ''}`} onClick={() => handleCardClick(card)}>
