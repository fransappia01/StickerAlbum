...
import BraStars from './bra-stars.png';
import Icon from '../../../icon.png';
import Icon2 from '../../../flecha-abajo.png';
import Icon3 from '../../../cerrar-sesion.png';

const Brasil = ({ savedStickers, setSavedStickers, albumId }) => {
            ...
            <div className='album-container'>
                <div className='brasil-album'>
                    <div className='title-country-container'>
                        ...
                        <button className='botoncito'>hola</button>
                    </div>
                    <img src={BraStars} alt="Estrellas de Brasil" className="bra-stars" style={{ width: 180, height: 180 }} />
                    <div className="row1">
                        {firstRow.map(card => (
